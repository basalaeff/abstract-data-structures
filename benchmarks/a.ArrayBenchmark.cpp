...
BENCHMARK(BM_ArrayAddToEnd)->Arg(100)->Arg(1000)->Arg(10000);
...
BENCHMARK(BM_ArrayAddToIndex)->Arg(100)->Arg(1000)->Arg(10000);
...
static void BM_ArrayGet(benchmark::State& state) {
  ...
  for (auto _ : state) {
    benchmark::DoNotOptimize(arr.get(state.range(0) / 2));
  }
}

BENCHMARK(BM_ArrayGet)->Arg(100)->Arg(1000)->Arg(10000);
...
BENCHMARK(BM_ArrayRemoveByIndex)->Arg(100)->Arg(1000)->Arg(10000);
...
BENCHMARK(BM_ArrayReplaceByIndex)->Arg(100)->Arg(1000)->Arg(10000);
...
BENCHMARK(BM_ArrayLength)->Arg(100)->Arg(1000)->Arg(10000);
