...
BENCHMARK(BM_DLListAddToHead)->Arg(100)->Arg(1000)->Arg(10000);
...
BENCHMARK(BM_DLListAddToTail)->Arg(100)->Arg(1000)->Arg(10000);
...
BENCHMARK(BM_DLListRemoveFromHead)->Arg(100)->Arg(1000)->Arg(10000);
...
BENCHMARK(BM_DLListRemoveFromTail)->Arg(100)->Arg(1000)->Arg(10000);
...
BENCHMARK(BM_DLListInsertBefore)->Arg(100)->Arg(1000)->Arg(10000);
...
BENCHMARK(BM_DLListRemoveBefore)->Arg(100)->Arg(1000)->Arg(10000);
...
BENCHMARK(BM_DLListRemoveAfter)->Arg(100)->Arg(1000)->Arg(10000);
...
BENCHMARK(BM_DLListSearchByValue)->Arg(100)->Arg(1000)->Arg(10000);
...
BENCHMARK(BM_DLListRemoveByValue)->Arg(100)->Arg(1000)->Arg(10000);
